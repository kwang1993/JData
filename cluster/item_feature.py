...
def get_from_item_duration():
    df_item_duration = pd.read_csv(ITEM_DURATION, header=0)
    return df_item_duration
...
if __name__ == "__main__":
    ...
    item_buy_duration = get_from_item_duration()
    ...
    item_behavior = pd.merge(
        item_behavior, item_buy_duration, on=['sku_id'], how='left')
